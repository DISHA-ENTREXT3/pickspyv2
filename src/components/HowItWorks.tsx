    ...
    <section className="py-24 bg-black/20 relative">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-[2.5rem] left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-primary/30 to-transparent" />

          {steps.map((step, index) => (
            <div key={index} className="relative z-10">
              <div className="bg-background border border-primary/20 w-20 h-20 rounded-2xl flex items-center justify-center text-3xl font-bold text-primary mx-auto mb-8 shadow-[0_0_30px_-10px_rgba(99,102,241,0.5)]">
                {step.number}
              </div>
